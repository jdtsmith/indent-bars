...
- Work correction with ~whitespace-mode~ and other modes which change the character display tables to ensure display spaces for blank lines are not visible.
